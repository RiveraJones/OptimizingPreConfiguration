...
function [InitialObservation,LoggedSignals] = myResetFunctionTesting %[InitialObservation,LoggedSignals] = myResetFunction
...
try
   ...
   if rangeDown < 300 %rangeValues   %CAMBIAR AQUI EMG tope------------- EMG #
   rangeDown=rangeDown+1;
   LoggedSignals.EMGs=rangeDown ;
   assignin('base','rangeDown', rangeDown);
   else
   rangeDown=1;                    %CAMBIAR AQUI EMG inicial Ej: 1, o 150 etc------------- EMG #
   LoggedSignals.EMGs=rangeDown;
   assignin('base','rangeDown', rangeDown);
   end
catch exception
...
%     if rangeDown2 > 150           %CAMBIAR AQUI------------- EMG #
%         disp("IF2")
...
%---------------feb------------------------
LoggedSignals.etiquetas_labels_predichas_matrix=strings(20,numEpochs);  %ESTE 42 hay que cambiar
%------------------------------------------
